...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col justify-between p-6 md:p-12 font-sans relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-auto bg-mono-900 border border-mono-700 p-8 md:p-10 rounded-card z-10 flex flex-col gap-6 shadow-2xl">
        ...
        <Button
          ...
          variant="primary"
          size="lg"
          className="w-full gap-3 py-3.5 mt-2"
        >
      ...
      {/* Footer Info */}
      <div className="text-center text-xs text-mono-500 z-10">
        © {new Date().getFullYear()} Protected Admin Portal.
      </div>
    </div>
  );
}
